...
public class TwoPairsIdentifier extends AbstractHandIdentifier {
	private static final Logger logger = LoggerFactory.getLogger(TwoPairsIdentifier.class);
	private static final int TWO_PAIR = 2;

	public TwoPairsIdentifier(AbstractHandIdentifier next) {
		super(next);
	}
