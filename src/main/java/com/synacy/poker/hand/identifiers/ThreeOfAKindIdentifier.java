...
public class ThreeOfAKindIdentifier extends AbstractHandIdentifier {
	private static final Logger logger = LoggerFactory.getLogger(ThreeOfAKindIdentifier.class);
	private static final int TRIPLETS = 3;
	private static final int TWO_HIGH_PAIR = 2;
	
	public ThreeOfAKindIdentifier(AbstractHandIdentifier next) {
		super(next);
	}
