...
public class StraightFlushIdentifier extends AbstractHandIdentifier {

	private static final Logger logger = LoggerFactory.getLogger(StraightFlushIdentifier.class);

	public StraightFlushIdentifier(AbstractHandIdentifier next) {
		super(next);
	}
