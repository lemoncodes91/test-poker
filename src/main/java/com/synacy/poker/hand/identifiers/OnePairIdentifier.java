...
public class OnePairIdentifier extends AbstractHandIdentifier {
	private static final Logger logger = LoggerFactory.getLogger(OnePairIdentifier.class);
	private static final int TWO_PAIR = 2;
	
	public OnePairIdentifier(AbstractHandIdentifier next) {
		super(next);
	}
